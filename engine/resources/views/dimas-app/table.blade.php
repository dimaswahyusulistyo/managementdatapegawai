...
@section('title', 'AdminLTE 3 | Daftar Agama')
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="{{ url('/form') }}" class="btn btn-primary mb-3">Tambah Agama</a>
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $agama->nama }}</td>
                    <td>
                      <a href="{{ route('dimas-app.editagama', $agama->id) }}" class="btn btn-warning">Edit</a>
                      <form action="{{ route('dimas-app.destroyagama', $agama->id) }}" method="post" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                          @csrf
                          @method('DELETE')

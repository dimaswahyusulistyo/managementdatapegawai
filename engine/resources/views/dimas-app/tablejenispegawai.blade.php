              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $jenispegawai->jenispegawai }}</td>
                    <td>
                      <a href="{{ route('dimas-app.editjenispegawai', $jenispegawai->id) }}" class="btn btn-warning">Edit</a>
                      <form action="{{ route('dimas-app.destroyjenispegawai', $jenispegawai->id) }}" method="post" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                          @csrf
                          @method('DELETE')

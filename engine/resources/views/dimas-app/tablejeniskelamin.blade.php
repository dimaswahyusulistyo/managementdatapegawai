...
@section('title', 'AdminLTE 3 | Daftar Jenis Kelamin')
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="{{ url('/formjeniskelamin') }}" class="btn btn-primary mb-3">Tambah Jenis Kelamin</a>
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('dimas-app.editjeniskelamin', $jeniskelamin->id) }}" class="btn btn-warning">Edit</a>
                      <form action="{{ route('dimas-app.destroyjeniskelamin', $jeniskelamin->id) }}" method="post" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                          @csrf
                          @method('DELETE')
